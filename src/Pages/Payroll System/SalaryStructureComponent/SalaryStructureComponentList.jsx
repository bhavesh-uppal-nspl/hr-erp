...
import { fetchPayrollComponents, fetchSalaryStructureComponent } from "../../../Apis/Payroll";

function SalaryStructureComponentList() {
  ...
  useEffect(() => {
    if (org?.organization_id) {
      setLoading(true);
      fetchSalaryStructureComponent(org?.organization_id)
        .then((data) => {
          let a = data?.salarystructure;
          console.log("break", a);
          let b = a.map((item) => {
            return {
              ...item,
              id: item.organization_payroll_employee_salary_structure_component_id ,
              payroll_component: item?.payroll_component_type?.payroll_component_type_name,
              salary_structure: item?.payroll_component_type?.payroll_component_type_name,
  ...
  let deleteBreak = async (id) => {
    try {
      ...
      const response = await axios.delete(
        `${MAIN_URL}/api/organizations/${org_id}/payroll/salary-component/${id}`,
        {
          headers: {
  ...
  return (
    <>
      ...
      <TableDataGeneric
        tableName="Payroll Salary Structure Components"
        primaryKey="organization_payroll_employee_salary_structure_component_id"
...
export default SalaryStructureComponentList;
