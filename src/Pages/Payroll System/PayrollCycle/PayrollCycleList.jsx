...
import { fetchPayrollComponents, fetchPayrollCycle } from "../../../Apis/Payroll";
...
function PayrollCycleList() {
  ...
  let deleteBreak = async (id) => {
    try {
      ...
      const response = await axios.delete(
        `${MAIN_URL}/api/organizations/${org_id}/payroll-cycle/${id}`,
        {
          headers: {
  ...
  const handleEdit = useCallback(
    (item) => {
      navigate(`/payroll/cycles/edit/${item.id}`);
    },
