...
import {  fetchPayrollLoanTypes } from "../../../Apis/Payroll";

function PayrollLoanTypesList() {
      ...
      fetchPayrollLoanTypes(org?.organization_id)
        .then((data) => {
          ...
          let b = a.map((item) => {
            return {
              ...item,
              id: item?.organization_payroll_loan_type_id,
  ...
  let deleteBreak = async (id) => {
    try {
      ...
      const response = await axios.delete(
        `${MAIN_URL}/api/organizations/${org_id}/payroll-loan-type/${id}`,
        {
          headers: {
  ...
  const handleEdit = useCallback(
    (item) => {
      navigate(`/payroll/loan-types/edit/${item.id}`);
    },
  ...
  return (
    <>
      ...
      <TableDataGeneric
        tableName="Payroll Loan Type"
        primaryKey="organization_payroll_loan_type_id"
        heading="Payroll Loan Type"
        data={Break}
...
export default PayrollLoanTypesList;
