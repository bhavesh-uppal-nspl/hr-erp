...
import { fetchEmployeePayrollReimbursementTypes, fetchPayrollCycle } from "../../../Apis/Payroll";

function PayrollReimbursementTypeList() {
      ...
      fetchEmployeePayrollReimbursementTypes(org?.organization_id)
        .then((data) => {
          ...
          let b = a.map((item) => {
            return {
              ...item,
              id: item?.organization_payroll_cycle_id,
            };
          });
          setBreak(b);
        })
  ...
  let deleteBreak = async (id) => {
    try {
      ...
      const response = await axios.delete(
        `${MAIN_URL}/api/organizations/${org_id}/payroll-reimbursement-types/${id}`,
        {
          headers: {
  ...
  const handleEdit = useCallback(
    (item) => {
      navigate(`/payroll/reimbursement-types/edit/${item.id}`);
    },
  ...
  return (
    <>
      ...
      <TableDataGeneric
        tableName="Payroll Reimbursement Types"
...
export default PayrollReimbursementTypeList;
