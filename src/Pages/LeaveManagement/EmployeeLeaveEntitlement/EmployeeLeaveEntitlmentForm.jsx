...
function EmployeeLeaveEntitlmentForm({ mode }) {
  ...
  const validateForm = () => {
    ...
    if (!formData.max_accumulated_days) {
      errors.max_accumulated_days = "Max. accumulated days are required.";
    }
              ...
              <Grid container spacing={2}>
                ...
                <TextField
                  ...
                  onChange={(e) => {
                    handleChange(e);
                    handleChange({
                      target: { name: "entitled_days", value: "" },
                    });
                    handleChange({
                      target: { name: "max_accumulated_days", value: "" },
                    });
                    handleChange({
                      target: { name: "carry_forward_days", value: "" },
                    });
                  }}
                ...
                <TextField
                  ...
                  onChange={(e) => {
                    ...
                    let maxDays = 366;
                    if (formData?.entitlement_period === "annual")
                      maxDays = 366;
                    else if (formData?.entitlement_period === "monthly")
                      maxDays = 31;
                    else if (formData?.entitlement_period === "quarterly")
                      maxDays = 92;
                    else if (formData?.entitlement_period === "custom")
                      maxDays = 366;

                    if (value !== "" && value < 0) value = 0;
                    if (value !== "" && value > maxDays) value = maxDays;
                  ...
                  inputProps={{
                    ...
                    min: "0",
                    max:
                      formData?.entitlement_period === "annual"
                        ? 366
                        : formData?.entitlement_period === "monthly"
                          ? 31
                          : formData?.entitlement_period === "quarterly"
                            ? 92
                            : formData?.entitlement_period === "custom"
                              ? 365
                              : 366,
                  }}
                />
