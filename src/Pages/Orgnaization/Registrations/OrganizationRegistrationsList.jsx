        ...
        .then((data) => {
          ...
          const b = registrations.filter(Boolean).map((item) => ({
           ...
           id:item.organization_business_registration_id,
            ...
            registration_applicable:item?.registration_applicable==0? "✖":"✔",
            registration_expiry_date_applicable:item?.registration_expiry_date_applicable==0? "✖":"✔",
            RegistrationType:item?.registration_type[0]?.business_registration_type_name ==null ? "" :item?.registration_type[0]?.business_registration_type_name
    ...
    <Layout4
      ...
      Icons={[
        ...
        <HttpIcon sx={{ color: "text.secondary" }} />,
         ...
         tableHeaders={[
        {name : "Registration No." , value_key : "registration_number", textStyle:"capitalize" },
