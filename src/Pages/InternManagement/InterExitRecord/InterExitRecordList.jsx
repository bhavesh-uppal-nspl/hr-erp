        ...
        .then((data) => {
          ...
          let b = a.map((item) => {
            return {
              ...
              intern_name: `${capitalize(item.intern.first_name)} ${capitalize(item.intern.middle_name || "")} ${capitalize(item.intern.last_name || "")}
             `.trim(),
      ...
      Data={exit}
       tableHeaders={[
        ...
        {name : "Name" , value_key : "name" , width:"150px"},
         ...
         {name : "NoticePeriod Starts" , value_key : "notice_period_start", width:"170px" },
       
          {name : "NoticePeriod Ends" , value_key : "notice_period_end", width:"170px" },
           {name : "Resignation Date" , value_key : "resignation_date",width:"150px"  },
          {name : "Relieving Date" , value_key : "relieving_date",width:"150px"  },
           {name : "Interview" , value_key : "exit_interview_done",width:"50px"  },
      ]}
      Icons={[
